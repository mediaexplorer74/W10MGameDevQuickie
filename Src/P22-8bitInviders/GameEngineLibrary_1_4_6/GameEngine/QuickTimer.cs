...
{
  public class QuickTimer : SceneNode
  {
    public bool Running;
    public bool Expired;
    ...
    public event QuickTimerExpiredHandler ExpiredEvent;
    ...
    public override void Update(GameTime gameTime, ref Matrix worldTransform)
    {
      if (!this.Running)
        return;
      this._timeExpired += (float) gameTime.ElapsedGameTime.Milliseconds;
