...
namespace TiledSharp
{
    public abstract class TmxDocument
    {
        ...
        //TODO: remake file work for uwp world 
        protected XDocument ReadXml(string filepath)
        {
            ...
            //if (asm != null)
            manifest = default;//asm.GetManifestResourceNames();

            string fileResPath = filepath.Replace(
                    Path.DirectorySeparatorChar.ToString(), ".");

            //RnD
            string fileRes = fileResPath;//Array.Find(manifest, s => s.EndsWith(fileResPath));
            ...
            */
            {
                ...
                {
                    Debug.WriteLine("[ex] TileCore XDocument.Load(filepath... bug: "
                        +ex.Message);
                    return default;
                }
