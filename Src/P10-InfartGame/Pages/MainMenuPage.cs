    ...
    public class MainMenuPage
    {
            ...
            GameOrchestrator orchestrator)
        {
            ...
            else
            {
                ...
                else if (_fartDrawingInfos.HitBox((int)_fartTextSize.X, 
                    (int)_fartTextSize.Y)
                    .Contains(touchPoint))
                {
                    _soundManager.PlayFart();
                }
                else if (_scoreDrawingInfos.HitBox((int)_scoreTextSize.X,
                    (int)_scoreTextSize.Y)
                    .Contains(touchPoint))
                {
                    orchestrator.SetScoreState();
                }
                else if (_aboutDrawingInfos.HitBox((int)_aboutTextSize.X, 
                    (int)_aboutTextSize.Y)
                    .Contains(touchPoint))
                {
