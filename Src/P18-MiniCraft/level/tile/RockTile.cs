...
// Type: GameManager.level.tile.RockTile
...
namespace GameManager.level.tile
{
  public class RockTile : Tile
  {
    ...
    public RockTile(int id)
      : base(id)
    {
      this.col = Color.Get(444, 444, 333, 333);
      this.transitionColor = Color.Get(111, 444, 555, Level.DirtColor);
    }
      ...
      int attackDir)
    {
      if (item is ToolItem)
      {
        ...
        if (toolItem.MyType == ToolType.Pickaxe && player.PayStamina(4 - toolItem.ToolLevel))
        {
