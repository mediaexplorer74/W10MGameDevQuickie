...
using GameManager.Astronaut;
using GameManager.Background;
using GameManager.Drawing;
using GameManager.HUD;
...
namespace GameManager
{
    ...
    public class InfartGame
    {
        ...
        { 
            get => _larghezzaBuchi; 
            private set => _larghezzaBuchi = value; 
        }
            ...
            ILocalizedStringsRepository localizedStringsRepository)
        {
            ...
            _statusBar = new StatusBar(new Vector2(460, 435), 
                assetsLoader, soundManager);
            _gameOrchestrator = gameOrchestrator;

            SetRecordRectangle();

            //RnD
            //SetHighScore(settingsRepository.GetOrSetInt(
            //    GameScores.BestNumberOfMetersScoreKey, 0));
            SetHighScore(1000);
            ...
            _metriString = localizedStringsRepository.Get(
                GameStringsLoader.MetriTimeString);
            _recordMetersText = "RECORD!";

            _jalapenoPopupText = "JALAPENO!";
            _broccoloPopupText = localizedStringsRepository.Get(
                GameStringsLoader.BroccoloPowerupText);
            _beanPopupText = localizedStringsRepository.Get
                (GameStringsLoader.BeanPowerupText);
        ...
        private void NewGame()
        {
            ...
            _gameCameraHLimit = 
                -PlayableGameWorldHeight - _playerCamera.ViewPortHeight;
        ...
        public void Update(TimeSpan elapsed)
        {
            ...
            if (IsTimeToGameOver())
            {
                _gameOrchestrator.SetGameOverState(VerdureMangiate(), 
                    ScoreMetri, _statusBar.TotalJumps);
            }
        }
