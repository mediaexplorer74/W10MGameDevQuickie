...
// Type: GameManager.InvadersTough
...
{
  public class InvadersTough : InvadersCritterBase
  {
    public InvadersTough(GameScreen screen)
      : base(screen)
    {
    }
    ...
    {
      this.ship = new Sprite("tough", Vector2.Zero, "sheets/invaders", this.Screen);
