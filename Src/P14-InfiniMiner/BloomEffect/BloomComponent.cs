...
namespace Infiniminer
{
    public class BloomComponent
    {
        ...
        public void Draw(GraphicsDevice device)
        {
            ...
            //RnD
            GraphicsDevice.Textures[1] = default;//resolveTarget;

            Viewport viewport = GraphicsDevice.Viewport;

            DrawFullscreenQuad(renderTarget1.GetTexture(),
                               viewport.Width, /*viewport.Height*/default,
                               bloomCombineEffect,
                               IntermediateBuffer.FinalResult);
        }

        private void DrawFullscreenQuad(SharpDX.Direct3D11.Resource resource,
            RenderTarget2D renderTarget2, Effect gaussianBlurEffect, IntermediateBuffer blurredHorizontally)
        {
            throw new NotImplementedException();
        }

        private void DrawFullscreenQuad(ResolveTexture2D resolveTarget, 
            RenderTarget2D renderTarget1, Effect bloomExtractEffect, IntermediateBuffer preBloom)
        {
            throw new NotImplementedException();
        }

        private void DrawFullscreenQuad(SharpDX.Direct3D11.Resource resource, 
            int width, RenderTarget2D renderTarget2, Effect gaussianBlurEffect, IntermediateBuffer blurredHorizontally)
        {
            throw new NotImplementedException();
        }

        private void DrawFullscreenQuad(SharpDX.Direct3D11.Resource resource, ResolveTexture2D resolveTarget, RenderTarget2D renderTarget1, Effect bloomExtractEffect, IntermediateBuffer preBloom)
        {
            throw new NotImplementedException();
        }
