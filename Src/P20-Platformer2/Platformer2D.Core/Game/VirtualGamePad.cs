...
namespace Platformer2D
{
    class VirtualGamePad
    {
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(texture, new Vector2(64, baseScreenSize.Y - 64), 
                null, color, -MathHelper.PiOver2/*-90o*/, spriteCenter, 1, SpriteEffects.None, 0);
            ...
            spriteBatch.Draw(texture, 
                ...
                null, color, 0, Vector2.Zero, 1, SpriteEffects.None/*.FlipVertically*/, 0);
        }
