...
// Type: GameManager.level.tile.LavaTile
...
namespace GameManager.level.tile
{
  public class LavaTile : Tile
  {
      ...
      : base(id)
    {
      ...
      this.col = Color.Get(500, 500, 520, 550);
      this.transitionColor1 = Color.Get(3, 500, Level.DirtColor - 111, Level.DirtColor);
      this.transitionColor2 = Color.Get(3, 500, Level.SandColor - 110, Level.SandColor);
    }

    public override void Render(Screen screen, Level level, int x, int y)
    {
      this.wRandom = new Random((Tile.TickCount + (x / 2 - y) * 4311) / 10 * 54687121 + x * 3271612 + y * 341298716);
      bool flag1 = !level.GetTile(x, y - 1).ConnectsToLava;
      bool flag2 = !level.GetTile(x, y + 1).ConnectsToLava;
      bool flag3 = !level.GetTile(x - 1, y).ConnectsToLava;
      bool flag4 = !level.GetTile(x + 1, y).ConnectsToLava;
