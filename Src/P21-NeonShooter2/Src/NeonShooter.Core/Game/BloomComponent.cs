...
namespace BloomPostprocess
{
    public class BloomComponent : DrawableGameComponent
    {
        ...
        protected override void LoadContent()
        {
            ...
            bloomExtractEffect = default;//this.Game.Content.Load<Effect>("Shaders/BloomExtract");
			bloomCombineEffect = default;//this.Game.Content.Load<Effect>("Shaders/BloomCombine");
            gaussianBlurEffect = default;//this.Game.Content.Load<Effect>("Shaders/GaussianBlur");
        ...
        void SetBlurEffectParameters(float dx, float dy)
        {
            ...
            EffectParameter weightsParameter = default;
            EffectParameter offsetsParameter = default;
