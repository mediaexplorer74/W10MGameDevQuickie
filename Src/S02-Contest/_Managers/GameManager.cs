...
namespace GameManager
{
    ...
    public class GameManager
    {
        ...
        public GameManager(Game game, GraphicsDeviceManager graphics)
        {
            ...
            _hero = new(Glob.Content.Load<Texture2D>("orb"));
            _bTex = Glob.Content.Load<Texture2D>("bullet");
            _tTex = Glob.Content.Load<Texture2D>("target");

            _timer = new(
                Glob.Content.Load<SpriteFont>("TextFont"),
                Color.DimGray * 0.5f,
                new((Glob.SCREEN_WIDTH / 2) - 110, (Glob.SCREEN_HEIGHT / 2) - 128),
                20f
            );
        ...
        public void Reset()
        {
            ...
            _targets.Add(new(_tTex, new(Glob.SCREEN_WIDTH - 100, 100)));
            _targets.Add(new(_tTex, new(100, Glob.SCREEN_HEIGHT - 100)));
            _targets.Add(new(_tTex, new(Glob.SCREEN_WIDTH - 100, Glob.SCREEN_HEIGHT - 100)));
