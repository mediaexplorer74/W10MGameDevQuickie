...
namespace GameManager
{
    ...
    public class Layer
    {
        ...
        {
            _position.X += ((movement * _moveScale) + _defaultSpeed) * Glob.ElapsedSeconds;
        ...
        public void Draw()
        {
            Glob.SpriteBatch.Draw(_texture, _position, null, Color.White, 
                0, Vector2.Zero, Vector2.One, SpriteEffects.None, _depth);

            Glob.SpriteBatch.Draw(_texture, _position2, null, Color.White, 
                0, Vector2.Zero, Vector2.One, SpriteEffects.None, _depth);
        }
    }
}
