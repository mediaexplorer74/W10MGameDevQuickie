...
namespace GameManager.Components
{
    ...
    public class Splash : BaseDrawableGameComponent
    {
        ...
        public Splash(Game1 game)
            : base(game)
        {
            _version = new Version("1.0");//Assembly.GetEntryAssembly().GetName().Version;            
            _infoText.Append(
        ...
        private void UpdateSplash(KeyboardState kState, GameTime gameTime)
        {
            ...
            if (kState.IsKeyDown(Keys.Space) || kState.IsKeyDown(Keys.Enter) || kState.IsKeyDown(Keys.Escape)
                || kState.IsKeyDown(Keys.D1) || kState.IsKeyDown(Keys.D2) || kState.IsKeyDown(Keys.D3)
                || kState.IsKeyDown(Keys.D4) || kState.IsKeyDown(Keys.D5) || kState.IsKeyDown(Keys.D6)
                || kState.IsKeyDown(Keys.D7))
            {
