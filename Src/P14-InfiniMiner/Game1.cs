...
{
    public class Game1 : Game//StateMasher.StateMachine
    {
        ...
        public static PropertyBag propertyBag;
        private string CurrentStateType;
        internal string FrameRate;
        ...
        protected override void Initialize()
        {
            ...
            if (dataFile.Data.ContainsKey("width"))
                _graphics.PreferredBackBufferWidth = int.Parse(dataFile.Data["width"], 
                    System.Globalization.CultureInfo.InvariantCulture);

            if (dataFile.Data.ContainsKey("height"))
                _graphics.PreferredBackBufferHeight = int.Parse(dataFile.Data["height"], 
                    System.Globalization.CultureInfo.InvariantCulture);

            if (dataFile.Data.ContainsKey("fullscreen"))
                _graphics.IsFullScreen = bool.Parse(dataFile.Data["fullscreen"]);
            ...
            if (dataFile.Data.ContainsKey("volume"))
                volumeLevel = Math.Max(0, Math.Min(1, float.Parse(dataFile.Data["volume"], 
                    System.Globalization.CultureInfo.InvariantCulture)));
        ...
        protected override void LoadContent()
        {
            ...
            if (!NoSound)
            {
                songTitle = Glob.Content.Load<Song>("song_title");
            ...
            try
            {
                ...
                foreach (string s in publicList.Split("\r\n".ToCharArray()))
                {
                    ...
                    if (args.Length == 6)
                    {
                        ...
                        {
                            ServerInformation serverInfo = new ServerInformation(serverIp, args[0], 
        ...
        public async void UpdateNetwork(GameTime gameTime)
        {
                    ...
                    case NetMessageType.ConnectionRejected:
                        {
                            ...
                            {
                                await MessageBox.Show("Error: you are banned from this server!",
                                    default,
                                    default);
                            }
                            ChangeState("Infiniminer.States.ServerBrowserState");
        ...
        private void ChangeState(string v)
        {
